    ...
    return(
        <footer className="w-full flex justify-center items-center mt-25">
            <div className="max-w-[1300px] w-full px-4 flex flex-col justify-center items-center">
                <div className="w-full flex border-b border-b-white pb-13 justify-between items-center">
                    <div className="w-[25rem] flex flex-col items-start">
                        <Image 
                            ...
                            height={120}
                        />
                        <p className="text-white font-light">Esta edição especial do UNO®, o jogo de cartas adorado por todos, tem um visual totalmente exclusivo. Concebida com uma estética minimalista, essa versão é um grande presente para colecionadores de UNO®.</p>
                    </div>

                    <div className="flex flex-col gap-3 items-center">
                        <p className="text-white">Inscreva-se para saber de novidades do mundo UNO.</p>
                        <div className="w-[27rem] h-15 rounded-xl flex items-center bg-[#282828]">
